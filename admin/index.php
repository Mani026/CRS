                ...
                <form action="#" method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" name="fullname" placeholder="Enter fullname" class="form-control mt-4">
...
if(isset($_POST['login']))
{
    ...
    echo $query="SELECT fullname,password FROM admin WHERE fullname='$fullname' AND password='$password' ";
    ...
    {
        "<center><b>Password Are Wrong... <br>Please Try Again</b></center>";
    }
